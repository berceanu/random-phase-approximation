...
def isofigure(job_group, isoscalar_panel=False, vlines=False,
                minEnergy=None, maxEnergy=None, 
                maxIsoscalarR=100000., maxIsovectorR=13., # e^2*fm^2/MeV
...
def main_groupby(args):
    ...
    for key, group in rpa.groupby(('proton_number', 'neutron_number')):
        ...
        fig = isofigure(gr2, isoscalar_panel=args.isoscalar, vlines=args.vlines,
                                   minEnergy=args.minEnergy, maxEnergy=args.maxEnergy,
                                   maxIsoscalarR=args.maxIsoscalarR, maxIsovectorR=args.maxIsovectorR,
                                   code_mapping=code)
