...
class DipoleTransitions(Module):
    ...
    def __init__(self,
                 ...
                 template='cards/dipole_transitions.html',
                 **kwargs):
    ...
    def get_table(job):
        ...
        if not job.isfile(dip_conf_fn):
            ...
            for idx in df.index:
                ...
                row = {'transition': f"{neutron_proton}{from_state_orbital}{from_state_frac_html}&rarr;{neutron_proton}{to_state_orbital}{to_state_frac_html}",
