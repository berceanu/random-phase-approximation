...
void pair(int j, int parity) {
	...
	for (it = 1; it <= 2; it++) 
	{
	   ...
	   {
	      // quasiparticle (unoccupied or partially occupied) or antiparticle
	      // final state		 
	      j1 = nj[i1][it];
	      l1 = nl[i1][it];	    
