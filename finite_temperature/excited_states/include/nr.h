...
extern void beschb(double x, double *gam1, double *gam2, double *gampl,
	double *gammi);
float bessi(int n, float x);
float bessi0(float x);
float bessi1(float x);
extern void bessik(float x, float xnu, float *ri, float *rk, float *rip,
	float *rkp);
...
void dspline(double x[], double y[], int n, 
	    double yp1, double ypn, double y2[]);

double dsplint(double xa[], double ya[], double y2a[], 
	    int n, double x);
