...
//		     vo[st1][iso]*uo[st2][iso]);
                 monstrength *= (vv[st2][iso] - vv[st1][iso]);
...
//			  +iv[j]*vo[st1][iso]*uo[st2][iso]);
                        elstrength *= (vv[st2][iso] - vv[st1][iso]);
...
//		       +iv[j]*vo[st1][iso]*uo[st2][iso]);
                       dipol_skalar *= (vv[st2][iso] - vv[st1][iso]);
   ...
   //    if (abs0(sum_out)>0.1)
	...
	lorvecfile << xi*xxl << "\t" << xplot[xi][2] << endl;
        lorskal2file << xi*xxl << "\t" << xplot[xi][1]*pi*gamlor[1]/2.0 << endl;
        lorvec2file << xi*xxl << "\t" << xplot[xi][2]*pi*gamlor[2]/2.0 << endl;
    }
...
//                   if(erpa[energyc] <= 19.0 && erpa[energyc] >= 13.0)
	...
	strengthfile << "#isovector m_1-strength: " << m_1_vec_sum 
      ...
      if(j == 1)
      {
       ...
       strengthfile << "#IV m_1 strength: " << m_1_vec_sum <<endl;
       strengthfile << "#IV m_0 strength: " << m_0_vec_sum <<endl;
       strengthfile << "#isovector m_1/m_0 = " << m_1_vec_sum/m_0_vec_sum <<endl;
      }
        strengthfile << "#isoscalar m_1/m_0 = "
          << m_1_skal_sum/m_0_skal_sum<< endl;
...
//	 << m_1_vec_sum_low/m_0_vec_sum_low << endl;
	 ...
	 << m_1_vec_sum_low/m_1_vec_sum_high << endl << endl;
        strengthfile << "#isovector m_1 low/m_1 = " 
         << m_1_vec_sum_low/m_1_vec_sum << endl << endl;        
